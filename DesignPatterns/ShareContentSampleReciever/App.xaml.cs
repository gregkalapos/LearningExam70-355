    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            if(args.Kind == ActivationKind.ProtocolForResults)
            {
                ...
                result.Add("Result", "coool");

                var eventArgs = args as ProtocolForResultsActivatedEventArgs;
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            Debug.WriteLine("Family: " + Windows.ApplicationModel.Package.Current.Id.FamilyName);
